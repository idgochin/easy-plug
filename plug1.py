...
#             if current >= 2:
#                 # deactivate LED 1 and Relay 1
#                 GPIO.output(LED1_PIN, GPIO.LOW)
#                 GPIO.output(RELAY1_PIN, GPIO.HIGH)
#                 print("Relay 1 and LED 1 deactivated")
...
#         GPIO.output(LED1_PIN, GPIO.LOW)
#         GPIO.output(RELAY1_PIN, GPIO.HIGH)
#         inactive_plug("inactive-plug1.py")
#         # pupapay_plug("pay-plug1.py")
#         return
...
# LED1_PIN = 6    # LED 1 connected to GPIO 6
# RELAY1_PIN = 12 # Relay 1 connected to GPIO 12
# BUTTON1_PIN = 23  # Emergency stop button (same as main script)
...
#                 print("EMERGENCY STOP: Button 1 pressed!")
#                 emergency_stop = True
...
#         safe_shutdown("EZP000101", "Manual Stop")
#     finally:
#         # Final cleanup
#         GPIO.output(LED1_PIN, GPIO.LOW)
#         GPIO.output(RELAY1_PIN, GPIO.HIGH)
