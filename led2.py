...
# # Pin configuration
# LED2_PIN = 13  # GPIO pin where the LED is connected

# # GPIO setup
# GPIO.setwarnings(False)  # Disable GPIO warnings
# GPIO.setmode(GPIO.BCM)  # Use BCM pin numbering
# GPIO.setup(LED2_PIN, GPIO.OUT)  # Set the pin as an output

# # Blink function
# try:
#     while True:
#         GPIO.output(LED2_PIN, GPIO.HIGH)  # Turn the LED on
#         print("LED ON")
#         time.sleep(0.2)  # Wait 1 second
#         GPIO.output(LED2_PIN, GPIO.LOW)  # Turn the LED off
#         print("LED OFF")
#         time.sleep(0.2)  # Wait 1 second
