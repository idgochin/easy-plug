...
def read_data_from_file(plug_id):
    file_path = BALANCE_FILES.get(plug_id, "balance-plug3.json")  # Default to plug1.json if unknown
    try:
...
data = read_data_from_file("EZP000103")
print("data is",data)
...
write_balance_to_file("EZP000103", 0)
